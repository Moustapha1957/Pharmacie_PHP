...
<input type="number" name="paid_amount" autocomplete="off" placeholder="Montant payé" style="width: 300px; height:30px;  margin-bottom: 15px;"  required/><br>
      <button class="btn btn-success btn-block btn-large" name="submit">Soumettre</button>
        </center>
   </form>
</div>
</body>
