...
<body>
	   ...
	   <div class="expire" color="green" >
    	  <font size="5">Un médicament va expirer</font><br><hr>
    	  <input type="text"  id="name_med" size="4"  onkeyup="med_name()" placeholder="Recherchez des noms de médicaments.." title="Type in a name">
