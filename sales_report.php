...
<body>
 ...
 <div class="navbar navbar-inverse navbar-fixed-top"><!--*****Header******-->
  ...
  <strong>Depuis : <input type="date" style="width: 223px; padding:14px;" name="d1" class="tcal" autocomplete="off" value="" /> à : <input type="date" style="width: 223px; padding:14px;" name="d2" autocomplete="off" class="tcal" value="" />
   <button class="btn btn-info" style="width: 123px; height:50px; margin-top:-8px;margin-left:8px;" type="submit" name="submit"><i class="icon icon-search icon-large"></i> Recherche</button>
  </strong>
  </form></center>
  
  <center>
    <div class="alert alert-info" role="alert">
      <small><b>Info:</b> Toutes les factures téléchargées sont stockées dans le répertoire " <b>C:/invoices/</b> "</small>
    </div>
           ...
           ?>
            ...
            <tr>
              ...
              <td><?php echo $row['total_profit']?></td>
                  <td><a href="download.php?invoice_number=<?php echo $invoice_number?>"><button class="btn btn-success btn-md"><span class="icon-download-alt"></span> Télécharger</button></a>
               </td>
