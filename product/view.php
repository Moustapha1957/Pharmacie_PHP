      ...
      <div class="row">
        <div class="contentheader">
          <h1>Produits</h1>
            ...
            <input type="text"  id="name_med1" size="4"  onkeyup="med_name1()" placeholder="Filtrer à l'aide du code à barres" title="Type BarCode">
            <input type="text" size="4"  id="med_quantity" onkeyup="quanti()" placeholder="Filtrer en utilisant le nom du médicament" title="Type Medicine Name">
            <input type="text" size="4" id="med_exp_date" onkeyup="exp_date()" placeholder="Filtrer en utilisant la date d'enregistrement" title="Type in registered date">
            <input type="text" size="4" id="med_status" onkeyup="stat_search()" placeholder="Filtrer en utilisant la marge bénéficiaire" title="Type in profit amount">
           <a href="index.php?invoice_number=<?php echo $_GET['invoice_number']?>" id="popup"><button class="btn btn-success btn-md" name="submit"><span class="icon-plus-sign icon-large"></span> Ajouter un nouveau médicament</button></a>
           ...
           <button class="btn btn-primary btn-md" name="submit"><span class="icon-download icon-large"></span> Importer un fichier Excel</button>
  ...
  <!-- For more projects: Visit codeastro.com  -->
    ...
    ?>
      ...
      <div style="text-align:center;">
        Total des médicaments : <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $row;?>]</font>
      </div>
        ...
        <form method="POST">
          ...
          <table id="table0" class="table table-bordered table-striped table-hover">
           <thead>
             ...
             <th width="3%">#</th>
             <th width="3%">nom</th>
             <th width="1%">Catégorie</th>
             <th width="5%">Qté enregistrée</th>
             <th width="1%">Qté vendue</th>
             <th  width="1%">Qté restante</th>
             <th width="1%">Inscrit</th>
             <th style="background-color: #c53f3f;" width="1%">Expiration</th>
             <th width="1%">Remarque</th>     
             <th width="2%">Prix ​​actuel</th>
             <th width="2%">Prix ​​vente</th>
...
$(".delete").click(function(){//***Showing Alert When Deleting*****
  ...
  if(confirm("Supprimez ce produit !! Êtes-vous sûr ??")){
