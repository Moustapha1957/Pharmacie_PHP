        ...
        <tr>
            ...
            <td>
                <select style="width: 230px; height: 35px; border-color: #000080" name="status"> 
                 ...
                 <option value="Not Available">Indisponible</option>
                 </select></td>
        </tr>
      <?php endwhile; ?>
        <tr>
          <td></td>
          <td> <input type="submit" name="update" class="btn btn-success btn-md" style="width: 225px" value="Sauvegarder les modifications"> </td>
        </tr>
