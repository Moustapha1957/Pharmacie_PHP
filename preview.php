...
<body>
  ...
  <div class="container">
  	...
  	<a href="home.php?invoice_number=<?php echo $_GET['invoice_number']?>"><button class="btn btn-default"><i class="icon-arrow-left"></i> Retour aux ventes</button></a>

    <div id="content">

	<center><div style="font:bold 25px 'Arial';">Pharmacie</div><br>
  ...
  <form method="POST" action="save_invoice.php">
      ...
      <tr>
       <strong><h3>Numéro de facture:<?php echo $invoice_number?></h3></strong> 
        <?php echo $date?>
      </tr>
		<thead>
			<tr>
    ...
    <tbody><!-- For more projects: Visit codeastro.com  -->
      ...
      <!-- For more projects: Visit codeastro.com  -->
        <tr>
         ...
         <tr>
          <td colspan="4" style=" text-align:right;"><strong style="font-size: 18px;">&nbsp;&nbsp;Somme Retournée &nbsp;</strong></td>
          <td colspan="2"><strong style="font-size: 12px;">
          <?php
  ...
  <input type="submit" name="submit" class="btn btn-success btn-large" value="Soumettre et réaliser de nouvelles ventes" >
  <a href="javascript:Clickheretoprint()" class="btn btn-danger btn-md" style="float: right;"><i class="icon icon-print"></i> Imprimer</a>
